...
#include "PlatformPrefixConfigure.h"
...
//#if !defined(UNITY_RELEASE)
//#error "UNITY_RELEASE define must be set"
//#endif
//
//#if !defined(DEBUGMODE)
//#error "DEBUGMODE define must be set"
//#endif
//
//#if !defined(GAMERELEASE)
//#error "GAMERELEASE define must be set"
//#endif
//
//#if !DEBUGMODE && GAMERELEASE && !UNITY_RELEASE
//#error "Players should always be unity release if they are not in debug mode"
//#endif
//
//#if defined(_DEBUG) && !DEBUGMODE
//#error "Debug target but DEBUGMODE is not enabled???"
//#endif
//
//
